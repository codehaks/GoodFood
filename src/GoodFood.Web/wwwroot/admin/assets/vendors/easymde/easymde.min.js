    ...
    return function e(t, n, r) {
        ...
        10: [function (e, t, n) {
            ! function (e, r) {
                ...
                function J(e) {
                    return /\w/.test(e) || e > "Â€" && (e.toUpperCase() != e.toLowerCase() || Q.test(e))
                }
                ...
                function Ee(e) {
                    ...
                    var n = Se ? T("span", "â€‹") : T("span", " ", null, "display: inline-block; width: 1px; margin-right: -1px");
                    return n.setAttribute("cm-text", ""), n
                }

                function Te(e) {
                    if (null != Fe) return Fe;
                    var t = E(e, document.createTextNode("AØ®A")),
                ...
                function xt(e, t, n, r) {
                    ...
                    for (r && (o = []);
                        (r || c.pos < t.ch) && !c.eol();) c.start = c.pos, i = gt(l, c, u.state), r && o.push(new vt(c, i, je(a.mode, u.state)));
                ...
                function Ft(e, t) {
                    ...
                    if (s)
                        for (var p = 0; p < s.length; ++p) {
                            var m = s[p];
                            if (null != m.to && (m.to += c), null == m.from) kt(l, m.marker) || (m.from = c, u && (l || (l = [])).push(m));
                    ...
                    if (!u) {
                        ...
                        if (x > 0 && l)
                            for (var y = 0; y < l.length; ++y) null == l[y].to && (v || (v = [])).push(new wt(l[y].marker, null, null));
                ...
                function Nt(e, t) {
                    ...
                    if (r)
                        for (var i = void 0, o = 0; o < r.length; ++o)(i = r[o]).marker.collapsed && null == (t ? i.from : i.to) && (!n || Bt(n, i.marker) < 0) && (n = i.marker);
                    return n
                }
                ...
                function nn(e, t, n) {
                    ...
                    if (r)
                        for (var a, l, s, u, c, d, h, f = i.length, p = 0, m = 1, g = "", v = 0;;) {
                            ...
                            for (var T = 1; T < n.length; T += 2) t.addToken(t, i.slice(o, o = n[T]), Zt(n[T + 1], t.cm.options))
                }
                ...
                function mn(e, t, n, r) {
                    ...
                    if (e.options.lineNumbers || o) {
                        ...
                        if (l.setAttribute("aria-hidden", "true"), e.display.input.setUneditable(l), a.insertBefore(l, t.text), t.line.gutterClass && (l.className += " " + t.line.gutterClass), !e.options.lineNumbers || o && o["CodeMirror-linenumbers"] || (t.lineNumber = l.appendChild(T("div", Je(e.options, n), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + r.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + e.display.lineNumInnerWidth + "px"))), o)
                ...
                function qn(e) {
                    var t = 0;
                    if (e.widgets)
                        for (var n = 0; n < e.widgets.length; ++n) e.widgets[n].above && (t += Dn(e.widgets[n]));
                    return t
                }
                ...
                function dr(e, t, n, r) {
                    ...
                    var i = e.display;
                    if (r && n < i.viewTo && (null == i.updateLineNumbers || i.updateLineNumbers > t) && (i.updateLineNumbers = t), e.curOp.viewChanged = !0, t >= i.viewTo) Ct && Pt(e.doc, t) < i.viewTo && fr(e);
                    else if (n <= i.viewFrom) Ct && _t(e.doc, n + r) > i.viewFrom ? fr(e) : (i.viewFrom += r, i.viewTo += r);
                ...
                function Fr(e) {
                    for (var t = e.display, n = t.lineDiv.offsetTop, r = Math.max(0, t.scroller.getBoundingClientRect().top), i = t.lineDiv.getBoundingClientRect().top, o = 0, s = 0; s < t.view.length; s++) {
                        ...
                        if (!u.hidden) {
                            ...
                            if ((m > .005 || m < -.005) && (i < r && (o -= m), Ke(u.line, d), Ar(u.line), u.rest))
                                for (var g = 0; g < u.rest.length; g++) Ar(u.rest[g]);
                ...
                function Qr(e) {
                    ...
                    if (o)
                        for (var l = 0; l < o.length; ++l) o[l].lines.length || pe(o[l], "hide");
                    if (a)
                        for (var s = 0; s < a.length; ++s) a[s].lines.length && pe(a[s], "unhide");
                ...
                function li(e, t) {
                    for (var n = t.viewport, r = !0;; r = !1) {
                        if (r && e.options.lineWrapping && t.oldDisplayWidth != An(e)) r && (t.visible = Er(e.display, e.doc, n));
                ...
                function _i(e, t, n, r) {
                    ...
                    if ((i.lastOp == r || i.lastOrigin == t.origin && t.origin && ("+" == t.origin.charAt(0) && i.lastModTime > l - (e.cm ? e.cm.options.historyEventDelay : 500) || "*" == t.origin.charAt(0))) && (o = function (e, t) {
                        ...
                        }(i, i.lastOp == r))) a = X(o.changes), 0 == tt(t.from, t.to) && 0 == tt(t.from, a.to) ? a.to = Fi(t) : o.changes.push(Ri(e, t));
                    else {
                        var s = X(i.done);
                        ...
                        if (o.ranges) r.push(n ? Ci.prototype.deepCopy.call(o) : o);
                            ...
                            for (var s = 0; s < a.length; ++s) {
                                ...
                                if (l.push({
                                    ...
                                    for (var d in u)(c = d.match(/^spans_(\d+)$/)) && _(t, Number(c[1])) > -1 && (X(l)[d] = u[d], delete u[d])
                            }
                        }
                    }
                    return r
                ...
                function uo(e, t, n) {
                    ...
                    if (!(ve(e, "beforeChange") || e.cm && ve(e.cm, "beforeChange")) || (t = so(e, t, !0))) {
                        ...
                        if (r)
                            for (var i = r.length - 1; i >= 0; --i) co(e, {
                                from: r[i].from,
                                to: r[i].to,
                                text: i ? [""] : t.text,
                                origin: t.origin
                ...
                function Fo(e, t, n, r, i) {
                    ...
                    if (e.iter(s, n.line + 1, (function (r) {
                            u && o.collapsed && !u.options.lineWrapping && Rt(r) == u.display.maxLine && (l = !0), o.collapsed && s != t.line && Ke(r, 0),
                                function (e, t, n) {
                        ...
                        if (l && (u.curOp.updateMaxLine = !0), o.collapsed) dr(u, t.line, n.line + 1);
                        ...
                        if (n && !t.isReadOnly())
                            if (r && r.length && window.FileReader && window.File)
                                for (var i = r.length, o = Array(i), l = 0, s = function () {
                                        ...
                                        if (t.options.allowDropFileTypes && -1 == _(t.options.allowDropFileTypes, e.type)) s();
                                        else {
                                ...
                                try {
                                    ...
                                    if (d) {
                                        var h;
                                        if (t.state.draggingText && !t.state.draggingText.copy && (h = t.listSelections()), eo(t.doc, Si(n, n)), h)
                ...
                function ga(e) {
                    ...
                    if (!(me(t, e) || n.activeTouch && n.input.supportsTouch()))
                        if (n.input.ensurePolled(), n.shift = e.shiftKey, Cn(n, e)) s || (n.scroller.draggable = !1, setTimeout((function () {
                        ...
                        window.focus(), 1 == i && t.state.selectingText && t.state.selectingText(e), r && function (e, t, n, r, i) {
                            ...
                            e.options.dragDrop && Ae && !e.isReadOnly() && "single" == n && (i = u.contains(t)) > -1 && (tt((i = u.ranges[i]).from(), t) < 0 || t.xRel > 0) && (tt(i.to(), t) > 0 || t.xRel < 0) ? function (e, t, n, r) {
                                ...
                                if ("rectangle" == r.unit) r.addNew || (l = new wi(n, n)), n = ur(e, t, !0, !0), s = -1;
                                else {
                                    var d = va(e, n, r.unit);
                    ...
                    for (var u in o.wrapper.CodeMirror = this, Da(this), t.lineWrapping && (this.display.wrapper.className += " CodeMirror-wrap"), Ur(this), this.state = {
                            ...
                            function (e) {
                                ...
                                de(t.scroller, "touchstart", (function (i) {
                                    ...
                                    start: function (t) {
                                        return function (e, t) {
                                            if (a && (!e.state.draggingText || +new Date - Bo < 100)) Ce(t);
                                            else if (!me(e, t) && !Cn(e.display, t) && (t.dataTransfer.setData("Text", e.getSelection()), t.dataTransfer.effectAllowed = "copyMove", t.dataTransfer.setDragImage && !h)) {
                ...
                $a.prototype.init = function (e) {
                        ...
                        function g() {
                            if (null != i.selectionStart) {
                                var e = n.somethingSelected(),
                                    o = "â€‹" + (e ? i.value : "");
                                i.value = "â‡š", i.value = o, t.prevInput = e ? "" : "â€‹", i.selectionStart = 1, i.selectionEnd = o.length, r.selForContextMenu = n.doc.sel
                            }
                        }
                        ...
                        function v() {
                            if (t.contextMenuPending == v && (t.contextMenuPending = !1, t.wrapper.style.cssText = f, i.style.cssText = h, a && l < 9 && r.scrollbars.setScrollTop(r.scroller.scrollTop = u), null != i.selectionStart)) {
                                ...
                                var e = 0,
                                    o = function () {
                                        r.selForContextMenu == n.doc.sel && 0 == i.selectionStart && i.selectionEnd > 0 && "â€‹" == t.prevInput ? ei(n, lo)(n) : e++ < 10 ? r.detectingSelectAll = setTimeout(o, 500) : (r.selForContextMenu = null, r.input.reset())
                                    };
                        ...
                        e.prototype = {
                            ...
                            indentSelection: ti((function (e) {
                                for (var t = this.doc.sel.ranges, n = -1, r = 0; r < t.length; r++) {
                                    var i = t[r];
                                    if (i.empty()) i.head.line > n && (Ta(this, i.head.line, e, !0), n = i.head.line, r == this.doc.sel.primIndex && Mr(this));
                                    else {
                                        var o = i.from(),
                                            a = i.to(),
                                            l = Math.max(n, o.line);
                            ...
                            addWidget: function (e, t, n, r, i) {
                                var o, a, l, s = this.display,
                                    ...
                                    c = e.left;
                                if (t.style.position = "absolute", t.setAttribute("cm-ignore-events", "true"), this.display.input.setUneditable(t), s.sizer.appendChild(t), "over" == r) u = e.top;
        ...
        15: [function (e, t, n) {
            ! function (e, r) {
                "object" == typeof n && void 0 !== t ? r(n) : r((e = "undefined" != typeof globalThis ? globalThis : e || self).marked = {})
            }(this, (function (e) {
                "use strict";
                ...
                var L = function () {
                        ...
                        return n.space = function (e) {
                            ...
                            if (t) {
                                var n, i, o, a, l, s, u, c, d, h, f, p, m = t[1].trim(),
                                    g = m.length > 1,
                                    v = {
                                        type: "list",
                                        raw: "",
                                ...
                                for (var x = new RegExp("^( {0,3}" + m + ")((?: [^\\n]*)?(?:\\n|$))"); e && (p = !1, t = x.exec(e)) && !this.rules.block.hr.test(e);) {
                                    if (n = t[0], e = e.substring(n.length), c = t[2].split("\n", 1)[0], d = e.split("\n", 1)[0], this.options.pedantic ? (a = 2, f = c.trimLeft()) : (a = (a = t[2].search(/[^ ]/)) > 4 ? 1 : a, f = c.slice(a), a += t[1].length), s = !1, !c && /^ *$/.test(d) && (n += d + "\n", e = e.substring(d.length + 1), p = !0), !p)
                                        for (var y = new RegExp("^ {0," + Math.min(3, a - 1) + "}(?:[*+-]|\\d{1,9}[.)])"); e && (c = h = e.split("\n", 1)[0], this.options.pedantic && (c = c.replace(/^ {1,4}(?=( {4})*[^ ])/g, "  ")), !y.test(c));) {
                            ...
                            if (t) {
                                ...
                                if (n.header.length === n.align.length) {
                                    ...
                                    for (l = n.rows.length, r = 0; r < l; r++) n.rows[r] = S(n.rows[r], n.header.length).map((function (e) {
                                        return {
                                            text: e
                                        }
                                    }));
                                    for (l = n.header.length, i = 0; i < l; i++) n.header[i].tokens = [], this.lexer.inlineTokens(n.header[i].text, n.header[i].tokens);
                ...
                var I = function () {
                        ...
                        return a.lex = function (e) {
                            ...
                            for (; e;)
                                ...
                                if (i = e, this.options.extensions && this.options.extensions.startInline && function () {
                                    ...
                                    }(), n = this.tokenizer.inlineText(i, N)) e = e.substring(n.raw.length), "_" !== n.raw.slice(-1) && (s = n.raw.slice(-1)), l = !0, (r = t[t.length - 1]) && "text" === r.type ? (r.raw += n.raw, r.text += n.text) : t.push(n);
                                else if (e) {
                    ...
                    P = function () {
                        ...
                        return n.parse = function (e, t) {
                            void 0 === t && (t = !0);
                            var n, r, i, o, a, l, s, u, c, d, h, p, m, g, v, x, y, b, D, C = "",
                                w = e.length;
                            for (n = 0; n < w; n++)
                                if (d = e[n], !(this.options.extensions && this.options.extensions.renderers && this.options.extensions.renderers[d.type]) || !1 === (D = this.options.extensions.renderers[d.type].call({
                                    ...
                                    case "code":
                                        ...
                                        continue;
                                    case "table":
                                        for (u = "", s = "", o = d.header.length, r = 0; r < o; r++) s += this.renderer.tablecell(this.parseInline(d.header[r].tokens), {
                                            header: !0,
                                            align: d.align[r]
                                        });
                                        for (u += this.renderer.tablerow(s), c = "", o = d.rows.length, r = 0; r < o; r++) {
                                            for (s = "", a = (l = d.rows[r]).length, i = 0; i < a; i++) s += this.renderer.tablecell(this.parseInline(l[i].tokens), {
                                                header: !1,
                                                align: d.align[i]
                                            });
                ...
                _.options = _.setOptions = function (t) {
                    ...
                    var r, i = k.apply(void 0, [{}].concat(t)),
        ...
        18: [function (e, t, n) {
            ...
            function v(e, t, n, r, i, o) {
                ...
                l.className = e.name, l.setAttribute("type", i), n = null == n || n, e.name && e.name in r && (s[e.name] = e.action), e.title && n && (l.title = function (e, t, n) {
                    ...
                    return i
                }(e.title, e.action, r), a && (l.title = l.title.replace("Ctrl", "âŒ˜"), l.title = l.title.replace("Alt", "âŒ¥"))), e.noDisable && l.classList.add("no-disable"), e.noMobile && l.classList.add("no-mobile");
                var c = [];
            ...
            function S(e) {
                ...
                if ("single" === f) {
                    ...
                    if (u.line !== c.line || u.ch !== c.ch) {
                        ...
                        var D = u.line;
                        if (n(s.getLineHandle(u.line)) && ("fenced" === i(s, u.line + 1) ? (o = u.line, D = u.line + 1) : (a = u.line, D = u.line - 1)), void 0 === o)
            ...
            function R(e, t) {
                ...
                if (["png", "jpg", "jpeg", "gif", "svg"].includes(a)) $(n, r.image, i.insertTexts.uploadedImage, t);
                else {
            ...
            function ae(e) {
                ...
                if (void 0 === e.toolbar)
                    for (var o in e.toolbar = [], J) Object.prototype.hasOwnProperty.call(J, o) && (-1 != o.indexOf("separator-") && e.toolbar.push("|"), (!0 === J[o].default || e.showIcons && e.showIcons.constructor === Array && -1 != e.showIcons.indexOf(o)) && e.toolbar.push(o));
                        ...
                        o.previewImagesInEditor && f.querySelectorAll(".cm-image-marker").forEach((function (e) {
                            ...
                            if (t.innerText.match(/^!\[.*?\]\(.*\)/g) && !t.hasAttribute("data-img-src")) {
                                ...
                                if (window.EMDEimagesCache || (window.EMDEimagesCache = {}), n && n.length >= 2) {
                                    var r = n[1];
                                    if (window.EMDEimagesCache[r]) v(t, window.EMDEimagesCache[r]);
                                    else {
