...
(function (T, O) {
    ...
    O(n, "Core/Options.js", [n["Core/Globals.js"], n["Core/Time.js"], n["Core/Color.js"], n["Core/Utilities.js"]], function (f, a, n, y) {
        ...
        f.defaultOptions = {
            ...
            lang: {
                loading: "در حال بازگزاری...",
                months: "فروردین اردیبهشت خرداد تیر مرداد شهریور مهر آبان آذر دی بهمن اسفند".split(" "),
                shortMonths: "فرو ارد خرد تیر مرد شهر مهر آبا آذر دی بهم اسف".split(" "),
                weekdays: "یکشنبه دوشنبه سه شنبه چهارشنبه پنج شنبه جمعه شنبه".split(" "),
                decimalPoint: ".",
                numericSymbols: "kMGTPE".split(""),
                resetZoom: "بازنشانی زوم",
                resetZoomTitle: "بازنشانی زوم سطح 1:1",
                thousandsSep: ","
            },
            global: {},
            time: {
