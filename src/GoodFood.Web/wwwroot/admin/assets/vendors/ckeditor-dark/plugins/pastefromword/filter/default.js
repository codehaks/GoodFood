...
(function () {
            ...
            h = {
                ...
                elements: {
                    a: function (a) {
                        ...
                        a.attributes.name && w[a.attributes.name] && (a = w[a.attributes.name], a.attributes.href =
                    ...
                    p: function (a) {
                        ...
                        if (f.thisIsAListItem(b, a)) t.isEdgeListItem(b, a) && t.cleanupEdgeListItem(a), f.convertToFakeListItem(b, a), m.array.reduce(a.children, function (a, b) {
                    ...
                    font: function (a) {
                        ...
                        CKEDITOR.dtd.tr[a.parent.name] && CKEDITOR.tools.arrayCompare(CKEDITOR.tools.objectKeys(a.attributes), ["class", "style"]) ? k.createStyleStack(a, p, b) : x(a, p)
                    },
                    ul: function (a) {
                    ...
                    ol: function (a) {
                        if (d) return "li" == a.parent.name && 0 === m.indexOf(a.parent.children, a) && k.setStyle(a.parent, "list-style-type", "none"), f.dissolveList(a), !1
                    },
                    span: function (a) {
                        a.filterChildren(p);
                        a.attributes.style = k.normalizedStyles(a, b);
                        if (!a.attributes.style || a.attributes.style.match(/^mso\-bookmark:OLE_LINK\d+$/) || a.getHtml().match(/^(\s|&nbsp;)+$/)) {
                            for (var c =
                                    a.children.length - 1; 0 <= c; c--) a.children[c].insertAfter(a);
                            return !1
                        }
                    ...
                    table: function (a) {
                        ...
                        if (b.name && "div" === b.name && b.attributes.align && 1 === m.objectKeys(b.attributes).length && 1 ===
                            b.children.length) {
                    ...
                    "v:shape": function (a) {
                        ...
                        if (null === a.getFirst("v:imagedata")) c(a);
                            ...
                            "v:group" === a.parent.name ?
                                ...
                                }, CKEDITOR.NODE_ELEMENT, !0), a.filterChildren(p), a.name = "img", a.attributes.src = a.attributes.src || d, delete a.attributes.type)
                        }
                    },
                    style: function () {
                        return !1
    ...
    CKEDITOR.plugins.pastefromword.styles = {
        ...
        normalizedStyles: function (a, b) {
            ...
            "cke:li" == a.name && h["TEXT-INDENT"] && h.MARGIN && (a.attributes["cke-indentation"] = f.getElementIndentation(a), h.MARGIN = h.MARGIN.replace(/(([\w\.]+ ){3,3})[\d\.]+(\w+$)/, "$10$3"));
            for (var l = m.objectKeys(h),
                    q = 0; q < l.length; q++) {
                var n = l[q].toLowerCase(),
                    r = h[l[q]],
                    k = CKEDITOR.tools.indexOf;
                (g && -1 !== k(d, n.toLowerCase()) || e(null, n, r) || e(null, n.replace(/\-.*$/, "-")) || e(null, n) || e(a.name, n, r) || e(a.name, n.replace(/\-.*$/, "-")) || e(a.name, n) || e(r)) && delete h[l[q]]
            }
        ...
        sortStyles: function (a) {
            for (var b = ["border", "border-bottom", "font-size", "background"], c = m.parseCssText(a.attributes.style), d = m.objectKeys(c), e = [], g = [], h = 0; h < d.length; h++) - 1 !==
                m.indexOf(b, d[h].toLowerCase()) ? e.push(d[h]) : g.push(d[h]);
            e.sort(function (a, c) {
        ...
        pushStylesLower: function (a, b, c) {
            ...
            for (g in e)
                if (!(g.toLowerCase() in
                        d || d[g.toLowerCase().replace(/\-.*$/, "-")] || g.toLowerCase() in b)) {
        ...
        inliner: {
            ...
            parse: function (a) {
                ...
                var h;
                if (g)
                    for (g = g.cssRules, h = 0; h < g.length; h++) g[h].type ===
                        window.CSSRule.STYLE_RULE && a.push({
            ...
            sort: function (a) {
                return a.sort(function (a) {
                    ...
                    return function (a, b) {
                        ...
                        return 0 !== g ? g : c.indexOf(b.selector) -
            ...
            inline: function (a) {
                ...
                CKEDITOR.tools.array.forEach(c, function (a) {
                    ...
                    a = d.find(a.selector);
                    var c, f, q;
                    for (q = 0; q < a.count(); q++) c = a.getItem(q),
    ...
    CKEDITOR.plugins.pastefromword.lists = {
        ...
        removeSymbolText: function (a) {
            ...
            a.forEach(function (d) {
                !b && -1 < d.value.indexOf(c) && (d.value = d.value.replace(c, ""), d.parent.getHtml().match(/^(\s|&nbsp;)*$/) && (b = d.parent !== a ? d.parent : null))
            }, CKEDITOR.NODE_TEXT);
            b && b.remove()
        },
        setListSymbol: function (a, b, c) {
            ...
            if ("ol" == a.name) {
                ...
                o: "circle",
                "§": "square"
            }, !d["list-style-type"] && e[b] && (d["list-style-type"] =
                e[b]);
        ...
        setListStart: function (a) {
            ...
            switch (a.attributes["cke-list-style-type"]) {
                ...
                case "lower-alpha":
                case "upper-alpha":
                    a.attributes.start = f.getSubsectionSymbol(b[c]).replace(/\W/g,
                        "").toLowerCase().charCodeAt(0) - 96 - c;
                    break;
                case "decimal":
        ...
        createLists: function (a) {
            var b, c, d, e = f.convertToRealListItems(a);
                ...
                for (d = 0; d < h.length; d++) {
                    ...
                    for (c = b.attributes["cke-list-level"]; c > l.length;) {
                        ...
                        0 < m.length ? m[m.length -
                            1].add(r) : (m = new CKEDITOR.htmlParser.element("li", {
                    ...
                    for (; c < l.length;) l.pop(), k = l[l.length - 1], c == l.length && f.setListSymbol(k, b.attributes["cke-symbol"], c);
                    b.remove();
                    k.add(b)
                }
                l[0].children.length && (d = l[0].children[0].attributes["cke-symbol"], !d && 1 < l[0].children.length && (d = l[0].children[1].attributes["cke-symbol"]), d && f.setListSymbol(l[0], d));
        ...
        determineListItemValue: function (a) {
            if ("ol" === a.parent.name) {
                var b = this.calculateValue(a),
                    ...
                    d;
                c && (c = c[c.length - 1], d = a.parent.attributes["cke-list-style-type"] || this.numbering.getStyle(c), c = this.numbering.toNumber(c,
        ...
        calculateValue: function (a) {
            ...
            var c = null,
                d, e, g;
            for (g = a; 0 <= g && null === c; g--) e = b.children[g], e.attributes && void 0 !== e.attributes.value && (d = g, c = parseInt(e.attributes.value, 10));
        ...
        chopDiscontinuousLists: function (a,
            b) {
            for (var c = {}, d = [
                    []
                ], e, g = 0; g < a.length; g++) {
                var h = c[a[g].attributes["cke-list-level"]],
                    ...
                    k, n;
                h ? (n = h.type.match(/alpha/) && 7 == h.index ? "alpha" : n, n = "o" == a[g].attributes["cke-symbol"] && 14 == h.index ? "alpha" : n, k = f.getSymbolInfo(a[g].attributes["cke-symbol"], n), l = this.getListItemInfo(a[g]), (h.type != k.type || e && l.id != e.id && !this.isAListContinuation(a[g])) && d.push([])) : k = f.getSymbolInfo(a[g].attributes["cke-symbol"]);
                for (e = parseInt(a[g].attributes["cke-list-level"], 10) + 1; 20 > e; e++) c[e] &&
                    delete c[e];
    ...
    CKEDITOR.plugins.pastefromword.heuristics = {
        ...
        assignListLevels: function (a, b) {
            if (!b.attributes || void 0 === b.attributes["cke-list-level"]) {
                for (var c = [f.getElementIndentation(b)], d = [b], e = [], g = CKEDITOR.tools.array, h = g.map; b.next && b.next.attributes && !b.next.attributes["cke-list-level"] && t.isDegenerateListItem(a, b.next);) b = b.next, c.push(f.getElementIndentation(b)), d.push(b);
                var k = h(c, function (a, b) {
                        return 0 === b ? 0 : a - c[b - 1]
                    }),
                    m = this.guessIndentationStep(g.filter(c, function (a) {
                        return 0 !==
                            a
                    })),
                    e = h(c, function (a) {
                        return Math.round(a / m)
                    }); - 1 !== g.indexOf(e, 0) && (e = h(e, function (a) {
                    return a + 1
                }));
